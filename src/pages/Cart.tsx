...
import cartNavActive from "../assets/img/shopping-cart-colored-nav-mob.svg";
...
const Cart: React.FC = () => {
    return (
        <div>
            ...
            <footer className='mt-8 pb-4 px-4 flex justify-between md:hidden'>
                    ...
                    <div className='flex flex-col items-center'>
                        <Link to="/cart"><img src={cartNavActive} alt="" /></Link>
